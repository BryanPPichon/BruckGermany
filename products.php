    ...
    <div class="container-fluid">
            ...
            <div class="row align-items-center min-vh-100">
                ...
                <div class="col-auto p-0">
                    <div class="intro-image-container">
                        <img src="img/0nuestros-productos.png" alt="Nuestros Productos" class="img-fluid intro-main-image">
                    </div>
                </div>
        ...
        <div class="product-slide" id="slide-5">
            <div class="row align-items-center min-vh-100">
                ...
                <div class="col-auto p-0">
                    <div class="product-image-container">
                        <img src="img/Suspension_direccion.png" alt="Suspensión y Dirección" class="img-fluid product-main-image">
                    </div>
                </div>
