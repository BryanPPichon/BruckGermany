<<<<<<< Updated upstream
<header class="">
    <video preload="auto" loop="loop" autoplay="autoplay" playsinline="playsinline" muted="muted" class="vid-bg">
        <source src="video/gcsgedit.mp4" type="video/mp4">
    </video>
    ...
    <nav class="navbar navbar-expand-lg header-hover-zone fixed-top" id="navbar">
        <a class="navbar-brand ml-4 col-3 text-center" href="index.php">
            <img src="img/200_B&R.png" alt="Brück Germany" width="15%">
        </a>
...
<div class="over d-none">
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-8 offset-md-2 text-center">
                <h1 class="mb-1">Innovaciones para la seguridad de los conductores</h1>
                <h3>“Innovations for driver safety”</h3>
            </div>
        </div>
    </div>
</div>
